...
ResponsiveAnalogRead gain_0(gain_0_pot, false, amount_easing);
ResponsiveAnalogRead vol_0(vol_0_pot, false, amount_easing);
ResponsiveAnalogRead gain_1(gain_1_pot, false, amount_easing);
ResponsiveAnalogRead vol_1(vol_1_pot, false, amount_easing);
